 ...
 * NAPRAWA: Funkcja istnieje, ale zawsze zwraca TRUE (oszukujemy system)
 */
 ...
 * NAPRAWA: Zakomentuj to, jeśli masz długie utwory i 'strict: false' nie pomagało
 */
...
MushraValidator.prototype.checkConditionConsistency = function(_reference, _conditions) {
  ...
  // var numberOfChannels = _reference.getAudioBuffer().numberOfChannels; // Wyłączone sprawdzanie kanałów
  ...
  for (var i = 0; i < _conditions.length; ++i) {
    ...
    // numberOfChannels - TU BYŁ BŁĄD SKŁADNIOWY, TERAZ JEST WYŁĄCZONE POPRAWNIE
